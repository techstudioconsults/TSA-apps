...
export const onlineCourses: OnlineCourse[] = [
  {
    ...
    whyChoose: {
      ...
      description:
        "A practical, beginner-friendly program focused on real-world cybersecurity skills and hands-on practice.",
      features: [
        {
          icon: "/icons/MonitorPlay.svg",
          title: "Online Classes",
          description:
            "Live, interactive sessions with guided walkthroughs and real-time Q&A.",
        },
        {
          icon: "/icons/wifi.svg",
          title: "100% Online Learning",
          description:
            "Learn from anywhere with just your laptop and internet connection .",
        },
        {
          icon: "/icons/BookOpen.svg",
          title: "Beginner-Friendly",
          description:
            "No prior IT or security experience required. We start from the basics.",
        },
        {
          icon: "/icons/Kanban.svg",
          title: "Hands-On Projects",
          description:
            "Practice with real-world security scenarios and practical exercises.",
        },
        {
          icon: "/icons/PenNib.svg",
          title: "Modern Tools",
          description:
            "Learn and work with industry-relevant tools for networking & system security.",
        },
        {
          icon: "/icons/PersonSimpleSwim.svg",
          title: "Complete Journey",
          description:
            "From threat awareness and network security to access control, etc.",
        },
      ],
    },
    coreSkills: {
      ...
      description:
        "Master the essential competencies needed to protect organizations from evolving digital threats",
      skills: [
        {
    ...
    learningJourney: {
      ...
      description:
        "Our comprehensive curriculum is structured to take you from foundational concepts to advanced security practices.",
      units: [
        {
          unitNumber: 1,
    ...
    whoShouldJoin: {
      ...
      description:
        "Our program is designed to meet you where you are and take you where you want to go.",
      audiences: [
        {
          icon: "/icons/RocketLaunch.svg",
          title: "Absolute Beginners",
          description:
            "Starting a career in cybersecurity with no prior IT or security experience",
        },
        {
          icon: "/icons/Briefcase.svg",
          title: "Professionals Upskilling",
          description:
            "Adding in-demand cybersecurity skills to strengthen your technical profile",
        },
        {
          icon: "/icons/ArrowsClockwise.svg",
          title: "Career Switchers",
          description:
            "Transitioning into cybersecurity roles from IT or non-tech backgrounds",
        },
        // {
    ...
    outcomes: {
      ...
      description:
        "Graduate with practical, job-ready skills that employers are actively seeking in the cybersecurity field.",
      items: [
        {
          icon: "/icons/mark.svg",
          title: "Threat Analysis & Risk Management",
    ...
    faqs: [
      {
        ...
        answer:
          "No prior experience is required. Our program is designed for complete beginners and provides a comprehensive foundation in cybersecurity.",
      },
      {
        question: "Is the course fully online?",
        answer:
          "The program covers cybersecurity fundamentals, network security, access control, cryptography, web application security, and incident response.",
      },
      {
        question: "Will I gain practical skills?",
        answer:
          "Yes, the program includes hands-on labs, real-world projects, and practical exercises to ensure you gain practical, job-ready skills.",
      },
      {
        question: "What career can I pursue after this course?",
        answer:
          "Graduates can pursue roles such as Cybersecurity Analyst, IT Security Specialist, Security Consultant, and other entry to mid-level cybersecurity positions.",
      },
    ],
    cta: {
      ...
      description:
        "Develop skills that are critical across industries worldwide and start your cybersecurity career today.",
  ...
  },
  {
    ...
    whyChoose: {
      ...
      description:
        "A practical, beginner-friendly program focused on real-world data skills and portfolio-ready projects.",
      features: [
        // {
        //   icon: "/icons/RocketLaunch.svg",
        //   title: "Absolute Beginners",
        ...
        },
        {
          ...
          title: "Beginner-Friendly",
          description:
            "No prior data experience needed, we start from the fundamentals.",
        },
        {
          icon: "/icons/Kanban.svg",
          title: "Hands-On Projects",
          description:
            "Work on real-world datasets and practical tasks to reinforce learning.",
        },
        {
          icon: "/icons/PenNib.svg",
          title: "Modern Tools",
          description:
            "Learn and practice with Excel, SQL, Python, and Power BI / Tableau.",
        },
        {
          icon: "/icons/PersonSimpleSwim.svg",
          title: "Complete Journey",
          description:
            "From data cleaning and analysis to visualization and basic machine learning.",
        },
      ],
    },
    learningJourney: {
      ...
      description:
        "A carefully structured 7-unit curriculum designed to take you from beginner to job-ready",
      units: [
        {
          unitNumber: 1,
    ...
    whoShouldJoin: {
      ...
      audiences: [
        ...
        },
        {
          ...
          title: "Career Switchers",
          description:
            "Transitioning into analytics or tech from another field",
        },
        // {
        //   icon: "/icons/Briefcase2.svg",
    ...
    outcomes: {
      ...
      description:
        "Build practical data skills to analyze, visualize, and extract insights from real-world data.",
      items: [
        {
          icon: "/icons/mark.svg",
          title: "Data Cleaning & Preparation",
          description:
            "Organize, clean, and prepare raw data for accurate analysis.",
        },
        {
          icon: "/icons/mark.svg",
          title: "SQL & Data Querying",
          description:
            "Query, filter, and join datasets using SQL to answer real business questions.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Data Analysis with Python",
          description:
            "Analyze datasets using Python, NumPy, and Pandas for deeper insights.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Data Visualization & Dashboards",
          description:
            "Create clear, interactive dashboards using Power BI or Tableau.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Statistical Thinking & Insights",
          description:
            "Interpret trends, patterns, and results to support decision-making.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Introductory Machine Learning",
          description:
            "Build basic predictive models and understand core machine learning concepts.",
        },
    ...
    faqs: [
      {
        ...
        answer:
          "No prior experience is required. The program is designed for complete beginners and provides comprehensive training from the ground up.",
      },
      {
        question: "How is the certificate recognized?",
        answer:
          "Our certificate is recognized by industry professionals and employers. It demonstrates your commitment to learning and practical skills in data analytics.",
      },
      {
        question: "Can I pay in installments?",
        answer:
          "Yes, we offer flexible payment options including installment plans. Please contact us for more details.",
      },
      {
        question: "What happens if I miss a class?",
        answer:
          "All live classes are recorded and made available for review. You can access the recordings at any time to catch up on missed sessions.",
      },
      {
        question: "How long do I have access to the materials?",
        answer:
          "You will have lifetime access to all course materials, recordings, and resources after completing the program.",
      },
      {
        question: "Is there a certificate upon completion?",
        answer:
          "Yes, you will receive a certificate of completion upon successfully finishing the program.",
      },
    ],
    cta: {
      ...
      description:
        "Join the 12-week Data Analysis & Machine Learning program and gain skills that employers are actively looking for.",
      buttonText: "Apply Now!",
    },
  },
  {
    ...
    whyChoose: {
      ...
      description:
        "A practical, beginner-friendly program focused on building real-world web applications and portfolio-ready projects.",
      features: [
        // {
        //   icon: "/icons/Code.svg",
        ...
        // },
        {
          ...
          title: "Online Classes",
          description:
            "Live, interactive coding sessions with guided explanations and live demos",
        },
        {
          icon: "/icons/wifi.svg",
          title: "100% Online Learning",
        ...
        },
        {
          ...
          title: "Beginner-Friendly",
          description:
            "No prior coding experience needed, we start from the fundamentals.",
        },
        {
          icon: "/icons/Kanban.svg",
          title: "Hands-On Projects",
          description:
            "Build real-world frontend and backend applications to reinforce learning.",
        },
        {
          icon: "/icons/PenNib.svg",
          title: "Modern Tools",
        ...
        },
        {
          ...
          title: "Complete Journey",
          description:
            "From frontend interfaces to backend logic and deployment.",
        },
      ],
    },
    learningJourney: {
      ...
      description:
        "A comprehensive learning journey designed to take you from beginner to a job-ready full-stack developer.",
      units: [
        {
          unitNumber: 1,
      ...
      audiences: [
        {
          ...
          title: "Absolute Beginners",
          description:
            "Starting a career in web development with no prior coding experience",
        },
        {
          icon: "/icons/Briefcase.svg",
          title: "Professionals Upskilling",
          description:
            "Adding modern frontend and backend development skills to your toolkit",
        },
        {
          icon: "/icons/ArrowsClockwise.svg",
          title: "Career Switchers",
          description:
            "Transitioning into software development from another career path",
        },
        // {
        //   icon: "professional",
    ...
    outcomes: {
      ...
      description:
        "Deploy applications and connect frontend, backend, and databases",
      items: [
        {
          icon: "/icons/mark.svg",
        ...
        },
        {
          ...
          description:
            "Write clean, reliable code using modern JavaScript and TypeScript.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Backend Development",
          description:
            "Create servers, APIs, and application logic using Node.js and Express.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Database Management",
          description:
            "Store and manage data using databases like MongoDB and SQL.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Version Control & Collaboration",
          description:
            "Work professionally with Git, GitHub, branches, and pull requests.",
        },
        {
          icon: "/icons/mark.svg",
    ...
    faqs: [
      {
        ...
        answer:
          "The program is 18 weeks long, with live weekend classes and self-paced learning options.",
      },
      {
        question: "Is the program fully online?",
        answer:
          "Yes, the program is fully online with live weekend classes and recorded sessions available for review.",
      },
      {
        question: "Do I need prior experience?",
        answer:
      ...
      },
      {
        ...
        answer:
          "After enrollment, you'll receive access to the learning platform, course materials, and join the community. You'll be notified about class schedules and program details.",
      },
      {
        question: "Can I pay in installments?",
        answer:
    ...
    cta: {
      ...
      description:
        "In just 18 weeks, you could be applying for developer roles, working remotely, and earning globally. The only question is: will you start today?",
      buttonText: "Apply Now!",
    },
  },
  {
    ...
    whyChoose: {
      ...
      description:
        "Everything you need to launch your design career, packaged into a flexible format.",
      features: [
        // {
        ...
        },
        {
          ...
          title: "Beginner-Friendly",
          description:
            "No prior design experience needed, we start from the fundamentals.",
        },
        {
          icon: "/icons/Kanban.svg",
          title: "Hands-On Projects",
          description:
            "Apply what you learn through real-world design challenges.",
        },
        {
          icon: "/icons/PenNib.svg",
          title: "Modern Tools",
          description:
            "Master industry-standard tools like Figma, FigJam, and Miro.",
        },
        {
          icon: "/icons/PersonSimpleSwim.svg",
          title: "Complete Journey",
          description:
            "From research to prototyping — learn the full product design process.",
        },
      ],
    },
    learningJourney: {
      ...
      description:
        "A comprehensive journey from design fundamentals to building your portfolio.",
      units: [
        {
          unitNumber: 1,
      ...
      audiences: [
        {
          ...
          title: "Absolute Beginners",
          description:
            "Starting a career in UI/UX design with no prior design experience",
        },
        {
          icon: "/icons/Briefcase.svg",
          title: "Professionals Upskilling",
          description:
            "Adding product design and UI/UX skills to your existing career toolkit",
        },
        {
          icon: "/icons/ArrowsClockwise.svg",
          title: "Career Switchers",
          description:
            "Transitioning into product design from non-design or non-tech roles",
        },
        // {
    ...
    outcomes: {
      title: "What You'll Be Able to Do After 12 Weeks",
      description:
        "Great digital products don't happen by accident, they're intentionally designed with empathy, clarity, and purpose.. UI/UX remains one of the most in-demand careers in tech and digital product teams worldwide.",
      items: [
        {
          icon: "/icons/mark.svg",
          title: "User Research & Problem Definition",
          description:
            "Understand user needs through research, interviews, and insights to define problems.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Information Architecture & UX Flows",
          description:
            "Structure content and design clear user journeys, flows, and navigation systems.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Wireframing & Layout Design",
          description:
            "Create low- to mid-fidelity wireframes that translate ideas into usable layouts.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Visual & Interface Design",
          description:
            "Design clean, modern interfaces with strong design principles.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Prototyping & Interaction Design",
          description:
            "Build interactive prototypes to test ideas and demonstrate product behavior.",
        },
        {
          icon: "/icons/mark.svg",
          title: "Usability Testing & Iteration",
          description:
            "Validate designs through testing and refine solutions based on feedback.",
        },
    ...
    faqs: [
      {
        question: "What happens after I enroll?",
        answer:
          "After enrollment, you'll receive access to the learning platform, course materials, and join the design community. You'll be notified about class schedules and program details.",
      },
      {
        question: "Do I need a design background?",
        answer:
          "No design background is required. The program is designed for complete beginners and covers everything from fundamentals to advanced concepts.",
      },
      {
        question: "Can I pay in installments?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Yes, the program is fully online with live sessions and recorded content available for flexible learning.",
      },
      {
        question: "Will I get a project?",
        answer:
          "Yes, you'll work on multiple projects throughout the program, culminating in a capstone project that becomes part of your portfolio.",
      },
      {
        question: "Will I get recordings?",
        answer:
          "Yes, all live sessions are recorded and made available for review. You'll have access to recordings throughout the program.",
      },
    ],
    cta: {
      ...
      description:
        "Take the first step today, create meaningful digital products and open doors to new career opportunities.",
      buttonText: "Apply Now!",
    },
  },
];

export const getOnlineCourseBySlug = (
  slug: string,
