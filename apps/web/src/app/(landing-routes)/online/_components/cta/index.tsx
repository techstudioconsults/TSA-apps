      ...
      <section className="py-16 lg:py-24 bg-white text-white relative overflow-hidden">
        <Wrapper className={`max-w-[330px] md:max-w-2xl lg:max-w-4xl xl:max-w-6xl relative z-10 rounded-[25px] bg-[#1F2666] py-14 bg-cover`} style={{ backgroundImage: `url(${course.cta.bg})` }}>
          <div className={`text-center `}>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-white max-w-xl lg:max-w-2xl mx-auto">
              {course.cta.title}
            </h2>
            <p className="md:text-lg lg:text-xl  text-white mb-8 max-w-xl lg:max-w-2xl mx-auto">
            ...
            <CustomButton
              ...
              variant="primary"
              size="xl"
              className="bg-[#0266F4] hover:bg-blue-700 text-white px-20 py-5 text-lg  rounded font-bold"
            >
