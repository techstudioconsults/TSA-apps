      ...
      <Wrapper className="max-w-6xl">
        <div className="text-center">
          <div className="flex items-center justify-center gap-5 md:gap-10 lg:gap-32 mb-11">
            ...
            <Image width={59} height={99} src={"/icons/Right.svg"}
          alt={"icon"}/>
          </div>
          <p className="text-base md:text-xl lg:text-2xl text-gray-500 max-w-5xl mx-auto mb-6">You've tried YouTube tutorials. Maybe a free course or two. But months later, you still can't build anything, real. Sound familiar?</p>
          <p className="text-base md:text-xl lg:text-2xl text-gray-500 max-w-5xl mx-auto">
           Without structure, projects, guidance, and accountability, most learners never move from <span className="font-semibold text-black">"I'm learning"</span> - <span className="font-semibold text-black">"I'm employable."</span>
          </p>
        </div>
      </Wrapper>
    </section>
