      ...
      <>
        ...
        <Wrapper className="max-w-6xl">
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-11">
            ...
            <div className="bg-[#1F2666] rounded-lg p-6  relative border border-[#1F2666]">
    ...
    <>
      <section className="py-16 lg:py-24 bg-white">
        <Wrapper className="max-w-6xl">
          ...
          <div className="bg-[#1F2666] rounded-lg px-5 md:px-10 pt-5 md:pt-10 pb-10 md:pb-20  relative border border-[#1F2666] max-w-xl mx-auto ">
            <div className="mb-8">
